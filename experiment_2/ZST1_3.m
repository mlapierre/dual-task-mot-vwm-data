...
session_config.session_num = 15;
session_config.TestConditionTy6es = [Condition.PerformBoth Condition.PerformMOT Condition.PerformVWM Condition.PerformBoth];
...
num_blocks = 1;
data_set = 3;
StartSession('ZST1_3', session_config, num_blocks, data_set);