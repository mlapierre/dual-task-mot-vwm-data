...
blocksPerSession = 8;
conditions = 4;
trialsPerBlock = 8; % Blocks are shown twice, the 2nd time in reverse
trialsPerConditionPerSession = 16; % Thus there are 2 blocks per condition
...
fn{1} = 'UB1-1c_20-Feb-2012_MOT_VWM_FF_1_0.0.2_Session_1.mat';
fn{2} = 'UB1-2_21-Feb-2012_MOT_VWM_FF_1_0.0.2_Session_1.mat';
